...
// The radar needs source-level football evidence. Generic words such as
// "final", "referee", and "goal" also occur in other sports, so they are
// intentionally excluded from this admission vocabulary.
const WORLD_CUP_TERMS = ["世界杯", "worldcup", "world cup", "fifa", "世预赛"];
const FOOTBALL_TERMS = ["足球", "踢球", "男足", "女足", "国足", "英超", "欧冠", "西甲", "中超", "意甲", "德甲", "法甲", "世俱杯", "点球", "乌龙球", "var", "角球", "越位", "门将", "帽子戏法"];
